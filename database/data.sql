...
-- Dumping data for table customer_db.customer: ~4 rows (approximately)
DELETE FROM `customer`;
INSERT INTO `customer` (`id`, `dob`, `name`, `nic`, `parent_customer_id`) VALUES
	(5, '1998-05-12', 'Kasuni', '180123456V', NULL),
	(8, '1998-05-12', 'Kasunii', '1801234846V', NULL),
	(9, '1995-01-01', 'Nimalaa', '1500001811V', NULL),
	(10, '1995-01-01', 'Nimala', '1500001119V', NULL);
...
-- Dumping data for table customer_db.customer_address: ~6 rows (approximately)
...
-- Dumping data for table customer_db.customer_mobile: ~2 rows (approximately)
DELETE FROM `customer_mobile`;
